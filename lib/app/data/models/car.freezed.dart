...
class _$CarImpl implements _Car {
  ...
  @override
  String toString() {
    return 'Car(id: $id, model: $model, brand: $brand, price: $price, availability: $availability)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, model, brand, price, availability);
...
abstract class _Car implements Car {
  factory _Car(
      ...
      @DoubleToStringConvert() required final double price,
